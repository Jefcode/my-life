/**
 * This Component is the top profile + notifcation.
 * it is positioned absolute to avoid re-render on every page.
 */
...
const Header = () => {
  ...
  return (
    <div className='absolute top-0 right-0 flex items-center justify-between mb-8'>
