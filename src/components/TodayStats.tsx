	...
	return (
		<div className="">
			...
			<div className="flex flex-col sm:flex-row items-stretch gap-5 h-full">
				...
				<div className="bg-gradient-to-l from-gradientBlue-100 via-gradientBlue-200 to-gradientBlue-300 rounded-2xl p-4 flex-1 text-white flex flex-col justify-between">
					<div className="flex items-center gap-3 mb-12">
						<VideoIcon className="w-14 h-14" />
						<div className="flex flex-col">
