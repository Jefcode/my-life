...
const MeetingModal = ({ meeting, onClose }: MeetingModalProps) => {
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className='bg-white rounded-2xl fixed top-1/2 right-1/2 -translate-y-1/2 translate-x-1/2 max-w-[calc(100vw-20px)] w-[700px] max-h-[calc(100vh-20px)] z-20 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-neutral-100'>
